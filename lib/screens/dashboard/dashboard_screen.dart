              ...
              children: [
                ...
                ticketsAsync.when(
                  data: (tickets) {
                    ...
                    final progress = tickets.where((t) => t.status == 'in_progress' || t.status == 'assigned').length;
                  ...
                  error: (err, _) => Center(
                    child: Text('Gagal memuat status: $err'),
                  ),
                ),
                ...
                // Grid Menu Cards with rich designs
                Row(
                  children: [
                    Expanded(
                      child: _MenuCard(
                        title: 'Daftar Tiket',
                        subtitle: 'Lihat & Kelola Servis',
