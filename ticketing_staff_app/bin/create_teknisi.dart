...
void main() async {
  ...
  final email = 'teknisi_arsya@gmail.com';
  final password = 'teknisipassword123';
  final fullName = 'Teknisi Arsya';

  print('Registering teknisi account: $email...');
  ...
  try {
    ...
    if (response.statusCode == 200 || response.statusCode == 201) {
      print('-----------------------------------------');
      print('SUCCESS: Teknisi account created successfully!');
      print('Email: $email');
